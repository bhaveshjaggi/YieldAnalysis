# -*- coding: utf-8 -*-
"""
Created on Mon Feb 12 17:47:51 2019

@author: Bhavesh Jaggi
"""
...
def key_generator(title,products) :
    ...
    #item_tuple = [items for items in list_it if items[2]['title']==title ]
    item_tuple = [items for items in list_it ]
    return item_tuple
...
while (count <= total_images-monthly_gap+1) :
    if count == 1 :
        ...
        #key_tuple = key_generator("S2A_OPER_PRD_MSIL1C_PDMC_20161128T133732_R062_V20161128T052152_20161128T052152","products)
        ...
        while (total_len > 0) :
            ...
            if (item_dict1 == item_dict) & (bfr_tid1==bfr_tid) :
